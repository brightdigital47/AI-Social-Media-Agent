...
# 🔑 आपकी Gemini API Key यहाँ एकदम सही जगह सेट है
GOOGLE_API_KEY = "AQ.Ab8RN6KmjXL-aF_-UgoWw7t03j_ctYOMZEKaZk7kT-pY6foynw"
...
if uploaded_file is not None:
    ...
    if st.button("✨ वीडियो स्कैन करें और वायरल पोस्ट बनाएं"):
        with st.spinner("⏳ एआई आपकी वीडियो को देख रहा है और उसके अंदर का कंटेंट समझ रहा है... कृपया थोड़ा इंतज़ार करें।"):
            
            try:
                # 1. वीडियो को एक टेम्परेरी फाइल में सुरक्षित करना ताकि एआई इसे पढ़ सके
                with open("temp_video.mp4", "wb") as f:
                    f.write(uploaded_file.getbuffer())
                
                # 2. वीडियो को सीधे गूगल जेमिनी एआई के सर्वर पर अपलोड करना (यही असली तकनीक है!)
                ...
                2. 1 सस्पेंस से भरा हुआ इंस्टाग्राम रील्स कैप्शन (हिंदी-इंग्लिश मिक्स भाषा में) जो लोगों को पूरा वीडियो देखने पर मजबूर करे।
                3. टॉप 10 वायरल होने वाले हैशटैग्स (#) जो इस वीडियो को ट्रेंडिंग में ले जाएं।
                """
                
                # एआई से रिस्पॉन्स मांगना
                response = model.generate_content([video_file, prompt])
                
                # 4. काम पूरा होने के बाद टेम्परेरी फाइल को डिलीट करना
                ...
                st.info("💡 अगर सर्वर ओवरलोड आ रहा है, तो 1 मिनट बाद दोबारा बटन दबाएं।")

else:
    st.info("💡 शुरुआत करने के लिए कृपया ऊपर एक वीडियो फाइल अपलोड करें।")
